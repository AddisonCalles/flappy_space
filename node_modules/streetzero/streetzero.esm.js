...
var intersectionRectangles = function intersectionRectangles(rect1, rect2) {
  var xColision = intersectionStraight({
    p1: rect1.x,
    p2: rect1.x2
  }, {
    p1: rect2.x,
  ...
  var yColision = intersectionStraight({
    p1: rect1.y,
    p2: rect1.y2
  }, {
    p1: rect2.y,
...
var intersectionStraight = function intersectionStraight(line1, line2) {
  if (line1.p1 <= line2.p2 && line2.p1 <= line1.p2) {
    return true;
  } else if (line1.p2 >= line2.p1 && line2.p2 <= line2.p2) {
    return true;
  }
...
var math = {
  ...
  toFixed: toFixed,
  intersectionRectangles: intersectionRectangles,
  intersectionStraight: intersectionStraight
};
...
var Kinematic = /*#__PURE__*/function (_Drawable) {
  ...
  _proto.render = function render() {
    ...
    _Drawable.prototype.render.call(this);
  };
  ...
  _proto.hasColision = function hasColision(el) {
    return intersectionRectangles(this, el);
  };
...
export { Directions, Drawable, EventListener, Game, Health, Kinematic, LayerPath, Point, Vector, color, math };
